...
const StatusDropdown = ({
  ...
  return (
    <div ref={wrapperRef} className="relative inline-block">
      ...
      {open && (
        <div className={`absolute   left-0 top-full mt-2 w-40 rounded-sm border border-stone-200 bg-white shadow-lg z-auto ${menuClass}dark:bg-gray-700 dark:border-gray-800 dark:text-white`}>
